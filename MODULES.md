...
| `input_field_test.sh` | Input field corner: the box rounds with the theme's `ElementCornerRadius` as a theme binding (pixel radius, never a capsule scale), a theme switch re-states it, and field and card share one corner family. |

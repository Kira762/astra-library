...
- `keybind.luau` — listening state flag, input connection, and the original button-backed key cap. Clicking the cap enters capture mode; the next keyboard key or supported mouse button binds it, Backspace clears it, and Escape cancels.

      ...
      {open ? (
        ...
        >
          ...
          >
            ...
            {/* Keyboard hints only matter where there is a keyboard — hidden
                on phones by size and on any touch device by pointer type. */}
            <div className="hidden items-center gap-4 border-t border-line px-4 py-2 pb-[max(0.5rem,env(safe-area-inset-bottom,0px))] text-2xs text-subtle sm:flex [@media(pointer:coarse)]:hidden">

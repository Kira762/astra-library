  ...
  return (
    <footer className="mt-20 border-t border-line">
      ...
      <div className="border-t border-line">
        <div className="mx-auto flex max-w-shell flex-col gap-2 px-4 pb-[max(1.25rem,env(safe-area-inset-bottom,0px))] pt-5 text-xs text-subtle sm:flex-row sm:items-center sm:justify-between lg:px-6">
          <p>
